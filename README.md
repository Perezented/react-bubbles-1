...
-   [ ] What steps can you take in your web apps to keep your data secure?
        Don't share your logins and auth keys.
        Keep everything up to date.
-   [ ] Describe how web servers work.
        Web Servers are basically simple computer programs that dispense the web page when they are requested using the web client. The machines on which this program run are usually called as a server
